<div class="modal fade" id="modal1" style="height: 100%; background-color: black;" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-body mb-0 p-0">
             ...
             border:none;  position: absolute;top: 2; right: 2;" data-dismiss="modal"><i class="fa fa-times"
                        aria-hidden="true"></i>
                </button>
            </div>
