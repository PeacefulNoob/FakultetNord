                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label style="
    padding-right: 10px;
" for="name" class="col-md-4 col-form-label text-md-right">{{ __('Name') }}</label>
                        ...
                        <div class="form-group row">
                            <label style="
    padding-right: 10px;
" for="email" class="col-md-4 col-form-label text-md-right">{{ __('E-Mail Address') }}</label>
                        ...
                        <div class="form-group row">
                            <label style="
    padding-right: 10px;
" for="password" class="col-md-4 col-form-label text-md-right">{{ __('Password') }}</label>
                        ...
                        <div class="form-group row">
                            <label style="
    padding-right: 10px;
" for="password-confirm" class="col-md-4 col-form-label text-md-right">{{ __('Confirm Password') }}</label>
